     ...
     <div class="box_1">
      ...
      <div class="boxCenterList">
       ...
       <tr style="background:url(themes/ecmoban_choies/images/lineBg.gif) repeat-x left bottom;text-align:center; color:#c00; font-weight:bold;"><td width="25%" align="left" style="padding-left:20px"><?php echo $this->_var['lang']['username']; ?></td><td width="10%"><?php echo $this->_var['lang']['number']; ?></td><td width="45%"><?php echo $this->_var['lang']['bought_time']; ?></td><td width="20%"><?php echo $this->_var['lang']['order_status']; ?></td></tr>
       ...
       <div id="buy_pagebar" class="f_r" style="margin-top:10px">
        ...
        <div id="buy_pager">
          <?php echo $this->_var['lang']['pager_1']; ?><?php echo $this->_var['pager']['record_count']; ?><?php echo $this->_var['lang']['pager_2']; ?><?php echo $this->_var['lang']['pager_3']; ?><?php echo $this->_var['pager']['page_count']; ?><?php echo $this->_var['lang']['pager_4']; ?> <span> <a href="<?php echo $this->_var['pager']['page_first']; ?>"><?php echo $this->_var['lang']['page_first']; ?></a> <a href="<?php echo $this->_var['pager']['page_prev']; ?>"><?php echo $this->_var['lang']['page_prev']; ?></a> <a href="<?php echo $this->_var['pager']['page_next']; ?>"><?php echo $this->_var['lang']['page_next']; ?></a> <a href="<?php echo $this->_var['pager']['page_last']; ?>"><?php echo $this->_var['lang']['page_last']; ?></a> </span>
            <?php $_from = $this->_var['pager']['search']; if (!is_array($_from) && !is_object($_from)) { settype($_from, 'array'); }; $this->push_vars('key', 'item_0_25805900_1409305600');if (count($_from)):
    foreach ($_from AS $this->_var['key'] => $this->_var['item_0_25805900_1409305600']):
?>
            <input type="hidden" name="<?php echo $this->_var['key']; ?>" value="<?php echo $this->_var['item_0_25805900_1409305600']; ?>" />
            <?php endforeach; endif; unset($_from); ?><?php $this->pop_vars();; ?>
        </div>
        <?php else: ?>
         ...
         <div id="buy_pager" class="pagebar">
          ...
          <?php $_from = $this->_var['pager']['page_number']; if (!is_array($_from) && !is_object($_from)) { settype($_from, 'array'); }; $this->push_vars('key', 'item_0_25836200_1409305600');if (count($_from)):
    foreach ($_from AS $this->_var['key'] => $this->_var['item_0_25836200_1409305600']):
?>
                <?php if ($this->_var['pager']['page'] == $this->_var['key']): ?>
                <span class="page_now"><?php echo $this->_var['key']; ?></span>
                <?php else: ?>
                <a href="<?php echo $this->_var['item_0_25836200_1409305600']; ?>">[<?php echo $this->_var['key']; ?>]</a>
                <?php endif; ?>
            <?php endforeach; endif; unset($_from); ?><?php $this->pop_vars();; ?>
          ...
          <?php if ($this->_var['pager']['page_kbd']): ?>
            <?php $_from = $this->_var['pager']['search']; if (!is_array($_from) && !is_object($_from)) { settype($_from, 'array'); }; $this->push_vars('key', 'item_0_25872500_1409305600');if (count($_from)):
    foreach ($_from AS $this->_var['key'] => $this->_var['item_0_25872500_1409305600']):
?>
            <input type="hidden" name="<?php echo $this->_var['key']; ?>" value="<?php echo $this->_var['item_0_25872500_1409305600']; ?>" />
            <?php endforeach; endif; unset($_from); ?><?php $this->pop_vars();; ?>

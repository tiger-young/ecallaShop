...
?>
			...
			<?php endif; ?>
			<?php $_from = $this->_var['filter_attr_list']; if (!is_array($_from) && !is_object($_from)) { settype($_from, 'array'); }; $this->push_vars('', 'filter_attr_0_85849000_1409215089');if (count($_from)):
    foreach ($_from AS $this->_var['filter_attr_0_85849000_1409215089']):
?>
      <div class="screeBox">
			<strong><?php echo htmlspecialchars($this->_var['filter_attr_0_85849000_1409215089']['filter_attr_name']); ?> :</strong>
			<?php $_from = $this->_var['filter_attr_0_85849000_1409215089']['attr_list']; if (!is_array($_from) && !is_object($_from)) { settype($_from, 'array'); }; $this->push_vars('', 'attr');if (count($_from)):
